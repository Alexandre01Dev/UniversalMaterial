...
public enum Material_18 {
    ...
    private static Material_18[] byId = new Material_18[383];
    private final static Map<String, Material_18> BY_NAME = new HashMap<>();
    private final int maxStack;
    private final short durability;

    private Material_18(final int id) {
        this(id, 64);
    }

    private Material_18(final int id, final int stack) {
        this(id, stack, MaterialData.class);
    }

    private Material_18(final int id, final int stack, final int durability) {
        this(id, stack, durability, MaterialData.class);
    }

    private Material_18(final int id, final Class<? extends MaterialData> data) {
        this(id, 64, data);
    }

    private Material_18(final int id, final int stack, final Class<? extends MaterialData> data) {
        this(id, stack, 0, data);
    }

    private Material_18(final int id, final int stack, final int durability, final Class<? extends MaterialData> data) {
        this.id = id;
     ...
     */
    @Deprecated
    public static Material_18 getMaterial(final int id) {
     ...
     * @return Material if found, or null
     */
    public static Material_18 getMaterial(final String name) {
     ...
     * @return Material if found, or null
     */
    public static Material_18 matchMaterial(final String name) {
        Validate.notNull(name, "Name cannot be null");

        Material_18 result = null;
    ...
    static {
        for (Material_18 material : values()) {
